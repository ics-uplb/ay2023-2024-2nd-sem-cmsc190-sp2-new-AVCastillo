...
const GenerateAttendance=()=>{
    ...
    const createAttendance= async ()=>{
        if(startTime && endTime){
            ...
            const students=await axios.get(`/api/getStudIds?classId=${classId}`)
            const created= await axios.post(`/api/createAttendance`,{classId:classId,startSched:startTime.toString(),endSched:endTime.toString()})
            const indiv= await  axios.post(`/api/createIndivAttendance`,{classId:classId,studentIds:students.data,attendanceCollectionId:created.data._id,searchDate:created.data.startSched})
